...
/*
 * TESTE REALIZADO A PARTIR DA TELA "M_RECEPCAO_MANUT_AGENDA" P/ IDENTIFICAR UPDATE NO CAMPO DS_OBSERVACAO_GERAL"
 *
 * - UPDATE REALIZADO NA VIEW "VDIC_RECEPCAO_AGENDA" NAO CONTEM O CAMPO "DS_OBSERVACAO_GERAL"
 * - UPDATE REALIZADO NA TABELA "IT_AGENDA_CENTRAL" (APESAR DE NAO COSNTAR NO CODIGO ABAIXO)
 *      * CHECKAR 'Pkg_SCMA_M_RECEPCAO_MANU_AGE.P_CHK_AGENDA_CENTRAL' !!!
 *
 *
*/

---- Nova Linha ---- -- 24/02/2026 18:22:42

BEGIN Pkg_SCMA_M_RECEPCAO_MANU_AGE.P_CHK_AGENDA_CENTRAL(:1 , :2 ); END;
---- Nova Linha ---- -- 24/02/2026 18:22:50
...
/*
 * TESTE REALIZADO A PARTIR DA TELA "M_RECEPCAO_AGENDA" P/ IDENTIFICAR UPDATE NO CAMPO "DS_OBSERVACAO_GERAL"
 *
 * - UPDATE REALIZADO NA VIEW "VDIC_RECEPCAO_AGENDA" NAO CONTEM O CAMPO "DS_OBSERVACAO_GERAL"
 * - UPDATE REALIZADO NA TABELA "IT_AGENDA_CENTRAL" CONTEM O CAMPO "DS_OBSERVACAO_GERAL"
 *      * NOTA: A VIEW COMO ABSTRACAO DA TABELA JA DEVE FAZER ISSO
 *
 *
*/

---- Nova Linha ---- -- 24/02/2026 17:15:35
...
---- Nova Linha ---- -- 24/02/2026 17:15:35
UPDATE dbamv.it_agenda_central SET nr_fone = :1 ,cd_convenio = :2 ,NR_DDI_TELEFONE = :3 ,NR_DDD_FONE = :4 ,NR_DDI_CELULAR = :5 ,NR_DDD_CELULAR = :6 ,NR_CELULAR = :7 , cd_con_pla = :8 , ds_observacao_geral = :9 , cd_anestesista = :10 , sn_anestesista = :11
WHERE cd_it_agenda_central = :12
    or cd_it_agenda_pai = :13



---- Nova Linha ---- -- 24/02/2026 17:16:16
SELECT
    *
FROM (
        SELECT
...
-- VALIDACOES EM BANCO DOS EFEITOS DE TESTES REALIZADOS ATRAVES DAS DUAS TELAS

-- VIEW APRSENTA CAMPO "DS_OBSERVACAO_GERAL" ATUALIZADO
SELECT
    CD_AGENDA_CENTRAL,
    CD_PACIENTE,
    NM_PACIENTE,
...
WHERE CD_AGENDA_CENTRAL = 45120 AND CD_PACIENTE = 48053
;

-- TABELA APRSENTA CAMPO "DS_OBSERVACAO_GERAL" ATUALIZADO
SELECT
    CD_AGENDA_CENTRAL,
    CD_PACIENTE,
    NM_PACIENTE,
