...
FROM ( -- 1 FROM
	  SELECT 
          ...
          , Prev_Alta
          , Dias
          , Decode(Paciente,null,null,Decode(AgendaBlocoCirurgico,1,'setadireita',null)) CC
          , Decode(Paciente,null,null,Decode(AgendaHemodinamica,1,'setadireita',null)) HMD
          , Decode(Paciente,null,null,Decode(PrescricaoMedica,1,'Vermelha',2,'Amarela','Verde')) PRM
          , Decode(Paciente,null,null,Decode(ChecagemMedicacao,1,'Vermelha','Verde')) CKG
          , Decode(Paciente,null,null,Proximohorario) PXH
          , Decode(Paciente,null,null,Decode(Aprazamento,1,'Vermelha','Verde')) APZ
          , Decode(Paciente,null,null,VlrScoreEnfermagem) SCE
          , Decode(Paciente,null,null,VlrScoreMedico) SCM
          , Decode(Paciente,null,null,Decode(ResultadoExames,1,'Amarela',3,'Verde')) EXA
          , Decode(Paciente,null,null,Decode(ResultadoImagens,1,'Amarela',3,'Verde" >')) IMG
          , Decode(Paciente,null,null,Decode(PedidoFarmaciaAtrasado,1,'Vermelha'
          , Decode(PedidoFarmaciaPendente,1,'Amarela','Verde'))) PED
          , Decode(Paciente,null,null,Decode(PedidoFarmaciaDevolucao,1,'Amarela',2,'Vermelha','Verde')) DEV
	  FROM ( -- 2 FROM
	        SELECT 
	        	Leitos.Cd_Leito
	            , Leitos.Cd_Unid_Int
...
FROM ( -- 1 FROM
	  SELECT 
          ...
          , Decode(Paciente,null,null,Decode(AgendaBlocoCirurgico,1,'setadireita',null)) CC
          , Decode(Paciente,null,null,Decode(AgendaHemodinamica,1,'setadireita',null)) HMD
          , Decode(Paciente,null,null,Decode(PrescricaoMedica,1,'Vermelha',2,'AMARELO','Verde')) PRM
          , Decode(Paciente,null,null,Decode(ChecagemMedicacao,1,'Vermelha','Verde')) CKG
          , Decode(Paciente,null,null,Proximohorario) PXH
          , Decode(Paciente,null,null,Decode(Aprazamento,1,'Vermelha','Verde')) APZ
          , Decode(Paciente,null,null,VlrScoreEnfermagem) SCE
          , Decode(Paciente,null,null,VlrScoreMedico) SCM
          , Decode(Paciente,null,null,Decode(ResultadoExames,1,'Exclamação',3,'Verde')) EXA
          , Decode(Paciente,null,null,Decode(ResultadoImagens,1,'Exclamação',3,'Verde')) IMG
          , Decode(Paciente,null,null,Decode(PedidoFarmaciaAtrasado,1,'Vermelha'
          , Decode(PedidoFarmaciaPendente,1,'Exclamação','Vermelha'))) PED
          , Decode(Paciente,null,null,Decode(PedidoFarmaciaDevolucao,1,'Exclamação',2,'Vermelha','Verde')) DEV
	  FROM ( -- 2 FROM
	        SELECT 
	        	Leitos.Cd_Leito
	            , Leitos.Cd_Unid_Int
